// seed-review.mjs
// One-time script to seed the AppGild review account (sam@appgild.ai)
...
const DEMO_EMAIL = "sam@appgild.ai";
...
const BUSINESS = {
  businessName: "Peak Cool Air",
  technicianName: "Sam Carter",
  phone: "555-018-2200",
  email: "sam@peakcoolair.com",
  licence1Label: "EPA 608",
  licence1Number: "L148632",
  licence2Label: "",
  licence2Number: "",
  brandColor: "#0f172a",
  tagline: "Comfort you can count on",
  website: "peakcoolair.com",
};
